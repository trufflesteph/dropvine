  ...
  return (
    <footer className="border-t border-border mt-32">
      <div className="container py-14 md:py-20 grid grid-cols-2 md:grid-cols-4 gap-10 text-sm">
        <div className="col-span-2 md:col-span-2">
          ...
          <p className="mt-3 text-muted-foreground max-w-sm leading-relaxed">
            A platform for considered launches. Built for makers who release on their own clock.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-foreground text-muted-foreground">Manifesto</a></li>
            <li><a href="#" className="hover:text-foreground text-muted-foreground">Press</a></li>
      ...
      <div className="container pb-10 flex items-center justify-between text-xs text-muted-foreground">
        ...
        <span className="font-serif italic">A quieter way to launch.</span>
      </div>
    </footer>
  )
}
